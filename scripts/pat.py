...
def plot_pat(ecg_data, ecg_peaks, ppg_data, ppg_peaks,
             idx_ecg, idx_ppg, m_peaks, pats, show=True, save=True,
    ...
    fig, ax = plt.subplots(5, figsize=(25, 20))
...
if __name__ == "__main__":
    ...
    plot_pat(ecg_data, ecg_peaks, ppg_data, ppg_peaks,
             idx_ecg, idx_ppg, m_peaks, pats, show=True, save=False)
