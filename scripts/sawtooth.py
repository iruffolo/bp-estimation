...
def fit_sawtooth(x, y, plot=False):
    ...
    geneticParameters = generate_Initial_Parameters(x, y)
    print(f"Initial Parameters: {geneticParameters}")

    fitP, pcov = curve_fit(_create_sawtooth, x, y, geneticParameters)
    ...
    if plot:
        ...
        # corrected = y - model + fitP[2]
        # axes.plot(x, corrected, "r.")
